          ...
          <form role="form" method="post" class="formularioVenta">
            ...
            <div class="box-body">
              ...
              <div class="box">
                ...
                $porcentajeDescuento = $venta["descuento"] * 100 / $venta["neto"];
                        ...
                        <tr>
                          ...
                          <td style="width: 50%">
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" id="nuevoTotalVenta" name="nuevoTotalVenta" total="<?php echo $venta["neto"]; ?>" value="<?php echo $venta["total"]; ?>" readonly required disabled>
            ...
            <div class="box-footer">
              ...
              <button type="submit" class="btn btn-primary pull-right btnEditarProducto" id="btnVenta">Guardar cambios</button>
